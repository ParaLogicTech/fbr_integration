...
invoice_custom_fields = [
	...
	{"label": "FBR Digital Invoice #", "fieldname": "fbr_di_invoice_no", "fieldtype": "Data",
		"insert_after": "stin", "read_only": 1, "no_copy": 1, "in_standard_filter": 1, "search_index": 1},
	...
	{"label": "Refresh FBR Digital Invoice Values", "fieldname": "refresh_fbr_di_values", "fieldtype": "Button",
		"insert_after": "fbr_di_buyer_province", "depends_on": "eval:doc.docstatus == 0"},

	# Hidden Fields
	{"label": "FBR DI QR Code", "fieldname": "fbr_di_qrcode", "fieldtype": "Barcode",
		"insert_after": "refresh_fbr_di_values", "read_only": 1, "hidden": 1, "no_copy": 1},
